...
__all__ = [
    'SpSharedRecognizer', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'ISpeechVoiceStatus', 'eLEXTYPE_PRIVATE8', 'DISPID_SRRAudio',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS', 'SRTAutopause',
    'DISPID_SRRPhraseInfo', 'DISPID_SpeechRecoContextEvents',
    'SITooSlow', 'DISPID_SpeechFileStream', 'SRESoundStart',
    'SPSVerb', 'SGLexicalNoSpecialChars',
    'DISPID_SPEAudioStreamOffset', 'DISPID_SPEPronunciation',
    'SAFT11kHz16BitMono', 'SpeechPropertyResourceUsage', 'SDTAll',
    'DISPID_SVSyncronousSpeakTimeout', 'SVSFPurgeBeforeSpeak',
    'DISPID_SASFreeBufferSpace', 'DISPID_SLPSymbolic',
    'SVESentenceBoundary', 'SAFTADPCM_8kHzStereo', 'SBOPause',
    'SpeechCategoryVoices', 'DISPID_SAStatus', 'SRAImport',
    'SPEI_TTS_AUDIO_LEVEL', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SP_VISEME_18', 'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPEI_ADAPTATION', 'DISPID_SLGetGenerationChange',
    'SPCONTEXTSTATE', 'DISPID_SRRGetXMLErrorInfo', 'STCInprocServer',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SVPriority',
    'DISPID_SRGDictationSetState', 'DISPID_SpeechRecognizer',
    'SRCS_Enabled', 'ISpeechPhraseReplacement', 'SGRSTTTextBuffer',
    'SPLO_STATIC', 'SSSPTRelativeToStart', 'SpeechRecoEvents',
    'SPRECORESULTTIMES', 'SVEEndInputStream', 'DISPID_SRStatus',
    'ISpeechPhraseElement', 'ISpeechAudioStatus', 'SINoSignal',
    'SPEI_ACTIVE_CATEGORY_CHANGED',
    'SpeechPropertyHighConfidenceThreshold', 'DISPID_SGRsCommit',
    'DISPID_SRRecognizer', 'SpeechGrammarTagDictation',
    'SpeechCategoryPhoneConverters', 'ISpShortcut',
    'ISpeechTextSelectionInformation', 'DISPID_SABufferInfo',
    'DISPID_SMSADeviceId', 'SpeechDictationTopicSpelling',
    'DISPID_SGRName', 'SAFTCCITT_ALaw_44kHzStereo', 'ISpRecoGrammar2',
    'SPEVENTSOURCEINFO', 'SpeechTokenContext', 'SPAR_Medium',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SVAudioOutput',
    'DISPID_SPIProperties', 'DISPID_SLWWord', 'DISPID_SPPChildren',
    'DISPID_SDKDeleteValue', 'ISpeechAudioBufferInfo',
    'SpNullPhoneConverter', 'SPEI_START_INPUT_STREAM', 'SPPS_Unknown',
    'DISPID_SDKEnumValues', 'SpeechRuleState',
    'SWPUnknownWordUnpronounceable', 'SPAR_High',
    'SAFTNonStandardFormat', 'SpeechRegistryLocalMachineRoot',
    'Speech_Max_Pron_Length', 'DISPID_SPARecoResult',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SRGetRecognizers',
    'SPINTERFERENCE_NOSIGNAL', 'ISpeechLexiconWords',
    'SPEI_REQUEST_UI', 'DISPID_SPERequiredConfidence', 'SVP_14',
    'DISPID_SpeechPhraseElement', 'DISPID_SpeechPhraseRule',
    'DISPID_SOTsCount', 'SVF_Emphasis', 'SpeechVoicePriority',
    'DISPID_SPAPhraseInfo', 'SECFIgnoreCase', 'IStream',
    'SPRST_INACTIVE_WITH_PURGE', 'DISPID_SRCESoundEnd',
    'ISpRecognizer', 'SSFMOpenForRead', 'DISPID_SGRsItem',
    'SPSHORTCUTPAIR', 'DISPID_SRCRecognizer',
    'DISPID_SWFESamplesPerSec', 'DISPID_SpeechRecoContext',
    'SPAS_STOP', 'DISPID_SLPsItem', 'DISPID_SVSpeak',
    'ISpRecoContext2', 'DISPID_SOTRemoveStorageFileName',
    'SPEI_TTS_PRIVATE', 'SPSMF_UPS', 'SAFT22kHz8BitStereo',
    'SECNormalConfidence', 'SVP_5', 'SAFT32kHz16BitMono',
    'SPPS_Interjection', 'DISPID_SASCurrentSeekPosition',
    'eLEXTYPE_PRIVATE13', 'SECFIgnoreKanaType',
    'DISPID_SRSetPropertyNumber', 'SVP_3', 'ISpRecoResult',
    'DISPID_SGRAddState', 'ISpRecoCategory', 'SpeechPartOfSpeech',
    'DISPID_SPCIdToPhone', 'SAFTTrueSpeech_8kHz1BitMono',
    'SPTEXTSELECTIONINFO', 'SRSActiveAlways', 'SPXRO_Alternates_SML',
    'SPPHRASEELEMENT', 'DISPID_SASCurrentDevicePosition',
    'DISPID_SPRuleEngineConfidence', 'SPRST_ACTIVE_ALWAYS',
    'DISPID_SDKGetBinaryValue', 'SPPHRASERULE', 'SGRSTTDictation',
    'DISPID_SRGIsPronounceable', 'SRAORetainAudio', 'SPLEXICONTYPE',
    'SAFTCCITT_ALaw_22kHzMono', 'SPSUnknown', 'ISpeechGrammarRules',
    'DISPID_SRRTTickCount', 'DISPID_SPEsItem',
    'DISPID_SOTGetDescription', 'Speech_StreamPos_Asap',
    'SPGRAMMARWORDTYPE', 'SpeechEngineProperties', 'DISPID_SPPId',
    'SVSFPersistXML', 'DISPID_SpeechAudioFormat',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SGRSTsItem',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SVVolume',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SRRGetXMLResult', 'SVP_8', 'SRTStandard',
    'ISpRecognizer3', 'DISPID_SPAsCount', 'SDTDisplayText',
    'DISPID_SLWs_NewEnum', 'SITooLoud', 'ISpeechPhraseInfoBuilder',
    'SPWT_LEXICAL', 'DISPID_SpeechGrammarRuleState',
    'ISpeechObjectToken', 'SAFTADPCM_44kHzStereo',
    'DISPID_SpeechObjectToken', 'DISPID_SOTCDefault', 'SVP_15',
    'SpeechAddRemoveWord', 'Speech_Default_Weight',
    'DISPID_SADefaultFormat', 'ISpMMSysAudio',
    'DISPID_SRAudioInputStream', 'DISPID_SPPEngineConfidence',
    'ISpeechLexiconPronunciation', 'DISPID_SRDisplayUI',
    'ISpeechPhraseRule', 'SVP_18', 'SAFTCCITT_ALaw_11kHzMono',
    'SRADynamic', 'Speech_Max_Word_Length', 'ISpeechCustomStream',
    'DISPID_SVEStreamEnd', 'SPWORDPRONOUNCEABLE',
    'SAFTCCITT_ALaw_44kHzMono', 'eLEXTYPE_PRIVATE2',
    'ISpObjectTokenCategory', 'DISPID_SAFType', 'DISPID_SGRSTType',
    'SpTextSelectionInformation', 'SPSEMANTICFORMAT',
    'DISPID_SRGSetWordSequenceData', 'DISPID_SOTCGetDataKey',
    'DISPID_SLGetPronunciations', 'SPAUDIOSTATUS',
    'SPEI_SR_RETAINEDAUDIO', 'SP_VISEME_12', 'SAFT8kHz8BitStereo',
    'SPCT_SUB_COMMAND', 'DISPID_SMSSetData', 'SVEAudioLevel',
    'ISpeechPhraseAlternate', 'DISPID_SVEVoiceChange',
    'IInternetSecurityManager', 'SP_VISEME_3', 'DISPID_SRRTLength',
    'SpPhoneConverter', 'SpeechVoiceCategoryTTSRate',
    'DISPID_SpeechPhraseAlternates', 'SAFTCCITT_uLaw_22kHzStereo',
    'SVSFIsFilename', 'SVF_Stressed', 'DISPID_SGRClear',
    'SGDSInactive', 'SPWORD', 'SpeechCategoryRecoProfiles',
    'eLEXTYPE_LETTERTOSOUND', 'STCInprocHandler',
    'SECFNoSpecialChars', 'SPSHT_OTHER', 'DISPID_SRGetFormat',
    'DISPID_SVEWord', 'DISPID_SRGRecoContext',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'SPBO_PAUSE',
    'DISPID_SGRsCommitAndSave', 'DISPID_SVSCurrentStreamNumber',
    'eWORDTYPE_ADDED', 'SPSHORTCUTPAIRLIST', 'SPEI_SR_PRIVATE',
    'eLEXTYPE_MORPHOLOGY', 'SPSNotOverriden', 'STCLocalServer',
    'SPEI_VISEME', 'ISpeechPhraseAlternates',
    'DISPID_SPRuleNumberOfElements', 'ISpeechRecognizer',
    'SVSFParseSsml', 'SECFDefault', 'DISPID_SRIsUISupported',
    'SREHypothesis', 'DISPID_SpeechXMLRecoResult', 'SPRST_INACTIVE',
    'SAFT11kHz8BitMono', 'DISPID_SWFEFormatTag', 'SpeechLexiconType',
    'DISPID_SpeechLexiconPronunciation', 'DISPIDSPTSI',
    'eLEXTYPE_PRIVATE17', 'DISPID_SpeechBaseStream',
    'DISPID_SRGDictationLoad', 'DISPID_SPIRule',
    'SPEI_RECO_STATE_CHANGE', 'SPEI_SR_BOOKMARK', 'SPBO_TIME_UNITS',
    'SPINTERFERENCE_TOOQUIET', 'ISpeechWaveFormatEx',
    'SPDKL_LocalMachine', 'ISpNotifyTranslator', 'DISPID_SPIGetText',
    'SpeechEmulationCompareFlags', 'SASClosed',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SVSLastStreamNumberQueued',
    'ISpeechPhraseRules', 'SAFT11kHz8BitStereo', 'SAFT48kHz8BitMono',
    'SAFT8kHz8BitMono', 'SpeechStreamFileMode',
    'SRSInactiveWithPurge', 'DISPID_SRSNumberOfActiveRules',
    'SAFTText', 'DISPID_SRCRequestedUIType', 'DISPID_SABIEventBias',
    'DISPID_SPRNumberOfElements', 'SPCS_DISABLED',
    'eLEXTYPE_RESERVED8', 'SAFT8kHz16BitStereo',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SRCCreateGrammar', 'SPINTERFERENCE_LATENCY_WARNING',
    'DISPID_SRGCommit', 'SPPS_RESERVED2', 'DISPID_SPIStartTime',
    'SVP_7', 'eLEXTYPE_PRIVATE18', 'SREAudioLevel',
    'SDKLCurrentConfig', 'SPCT_SUB_DICTATION', 'SPPS_RESERVED4',
    'SP_VISEME_8', 'ISpeechXMLRecoResult', 'SpStream', 'SDTAudio',
    'SpCompressedLexicon', 'DISPID_SRGetPropertyNumber',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SPEI_PHRASE_START',
    'DISPID_SVSRunningState', 'SDTPronunciation',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'ISpeechPhraseElements',
    'DISPID_SDKDeleteKey', 'SP_VISEME_21',
    'SAFTCCITT_uLaw_8kHzStereo', 'SREAdaptation',
    'DISPID_SOTGetStorageFileName', 'DISPID_SOTGetAttribute',
    'DISPID_SRCERecognizerStateChange', 'SAFTCCITT_ALaw_11kHzStereo',
    'SVEVoiceChange', 'DISPID_SVRate', 'SAFTCCITT_uLaw_8kHzMono',
    'DISPID_SAFGuid', 'DISPID_SPRs_NewEnum',
    'SpeechAudioFormatGUIDText', 'eLEXTYPE_PRIVATE5',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SPINTERFERENCE_TOOFAST', 'SPPS_SuppressWord', 'STCAll',
    'SpPhoneticAlphabetConverter', 'SAFTGSM610_11kHzMono',
    'ISpeechLexiconPronunciations', 'DISPID_SGRSTPropertyName',
    'SpeechUserTraining', 'ISpeechRecoResult2', 'DISPID_SFSOpen',
    'DISPID_SVSpeakStream', 'DISPID_SPIAudioStreamPosition',
    'SP_VISEME_4', 'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SRCVoice', 'SVP_2', 'DISPID_SPIAudioSizeBytes',
    'DISPID_SRRTStreamTime', 'DISPID_SpeechPhraseProperties',
    'SVP_17', 'SPVPRI_OVER', 'DISPID_SpeechPhraseReplacements',
    'SLTApp', 'SpeechGrammarTagUnlimitedDictation',
    'SpeechBookmarkOptions', 'IInternetSecurityMgrSite',
    'SPEI_HYPOTHESIS', 'SDA_Two_Trailing_Spaces', 'DISPID_SASetState',
    'eLEXTYPE_PRIVATE16', 'SPEI_RECOGNITION',
    'SpeechTokenKeyAttributes', 'SpWaveFormatEx',
    'SpeechVoiceSkipTypeSentence', 'DISPID_SLPType',
    'DISPID_SPRDisplayAttributes', 'DISPID_SVEViseme',
    'DISPID_SRGCmdLoadFromResource', 'SPPS_NotOverriden',
    'ISpeechObjectTokens', 'SPPS_Noncontent', 'SASPause',
    'SREPropertyNumChange', 'DISPID_SGRsDynamic',
    'DISPID_SLAddPronunciationByPhoneIds', 'SPFM_CREATE',
    'SP_VISEME_20', 'SASStop', 'SP_VISEME_19', 'SAFTADPCM_11kHzMono',
    'SAFT32kHz8BitStereo', 'SpeechRecognizerState', 'SP_VISEME_2',
    'DISPID_SVSLastBookmarkId', 'DISPID_SLGenerationId',
    'DISPID_SVPause', 'SpAudioFormat', 'DISPID_SVEPhoneme',
    'SPPS_Modifier', 'DISPID_SOTCategory', 'STCRemoteServer',
    'SRERecognition', 'SVSFIsNotXML', 'SP_VISEME_13', 'SGSEnabled',
    'DISPID_SpeechMMSysAudio', 'SP_VISEME_16', 'DISPID_SPILanguageId',
    'eLEXTYPE_PRIVATE9', 'SpeechRegistryUserRoot', 'SPEI_MIN_SR',
    'DISPID_SPANumberOfElementsInResult', 'SPAO_NONE', 'SP_VISEME_15',
    'DISPID_SDKSetLongValue', 'SpeechWordPronounceable',
    'DISPID_SRGCmdLoadFromFile', 'ISpeechLexiconWord',
    'DISPID_SRCEInterference', 'SREPhraseStart', 'DISPID_SOTSetId',
    'SAFT24kHz8BitStereo', 'SDTAlternates', 'eLEXTYPE_RESERVED9',
    'SpInprocRecognizer', 'DISPID_SPPValue', 'SVP_10',
    'SPSSuppressWord', 'SAFT16kHz8BitMono', 'ISpPhrase',
    'SPSHT_EMAIL', 'SREStreamEnd', 'SVPNormal', 'IEnumString',
    'SVPOver', 'DISPID_SRCEEnginePrivate', 'SpVoice',
    'DISPID_SVGetAudioInputs', 'SDA_One_Trailing_Space',
    'SpeechDisplayAttributes', 'SP_VISEME_5', 'SPSHT_Unknown',
    'DISPID_SPAsItem', 'DISPID_SRCPause', 'ISpAudio',
    'SDKLLocalMachine', 'SVP_11', 'SVP_1', 'SSSPTRelativeToEnd',
    'SPBO_NONE', 'eWORDTYPE_DELETED', 'DISPID_SRAudioInput',
    'DISPID_SPPFirstElement', 'SITooFast', 'SAFT44kHz8BitMono',
    'DISPID_SVVoice', 'SAFT16kHz16BitStereo',
    'DISPID_SpeechLexiconWord', 'ISpVoice', 'DISPID_SPAs_NewEnum',
    'DISPID_SVESentenceBoundary', 'ISpeechDataKey',
    'DISPID_SDKGetStringValue', 'SAFTCCITT_uLaw_44kHzMono',
    'SREStreamStart', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPRulesItem', 'SPINTERFERENCE_TOOSLOW', 'SPPS_Verb',
    'DISPID_SPEAudioTimeOffset', 'SPWT_PRONUNCIATION',
    'DISPID_SRCEventInterests', 'SVEViseme', 'SpeechRunState',
    'SPSEMANTICERRORINFO', 'SRESoundEnd', 'SPEI_END_SR_STREAM',
    'SRERecoOtherContext', 'SVSFlagsAsync', 'SAFT44kHz16BitMono',
    'SGRSTTWord', 'DISPID_SPRulesCount', 'SAFT24kHz8BitMono',
    'DISPID_SOTMatchesAttributes', 'SVSFIsXML', 'SpeechVisemeFeature',
    'DISPID_SPPs_NewEnum', 'SPPHRASE', 'ISpeechGrammarRule',
    'DISPID_SLWsItem', 'DISPID_SWFEChannels', 'DISPID_SOTs_NewEnum',
    'STSF_AppData', 'SPEI_END_INPUT_STREAM',
    'DISPID_SRCSetAdaptationData', 'SPRST_ACTIVE', 'SPAS_RUN',
    'DISPID_SGRSTransitions', 'SPAUDIOOPTIONS', 'DISPID_SGRs_NewEnum',
    'DISPID_SGRSTPropertyValue', 'SRARoot', 'SPSFunction',
    'SpResourceManager', 'SDA_No_Trailing_Space', 'SPVPRIORITY',
    'SGPronounciation', 'DISPID_SpeechVoiceEvent',
    'DISPID_SRRTOffsetFromStart', 'DISPID_SRCEFalseRecognition',
    'SpFileStream', 'DISPID_SGRSAddWordTransition',
    'SPEI_FALSE_RECOGNITION', 'ISpProperties', 'DISPID_SRCERequestUI',
    'DISPID_SRCResume', 'eLEXTYPE_PRIVATE19', 'SVP_9',
    'DISPID_SDKSetBinaryValue', 'DISPID_SGRsAdd',
    'DISPID_SpeechGrammarRuleStateTransitions', 'SPRS_ACTIVE',
    'SDKLCurrentUser', 'SPWF_SRENGINE', 'STSF_CommonAppData',
    'DISPID_SpeechLexiconProns', 'DISPID_SRRSpeakAudio',
    'SVEAllEvents', 'DISPID_SGRSRule', 'ISpRecognizer2',
    'DISPID_SPEDisplayAttributes', 'SPEI_MAX_TTS',
    'SAFT12kHz8BitMono', 'SGRSTTWildcard', 'DISPID_SPRuleConfidence',
    'ISpeechPhraseProperties', 'DISPID_SPEs_NewEnum',
    'SAFT32kHz8BitMono', 'SAFT11kHz16BitStereo', 'SGRSTTRule',
    'DISPID_SRSClsidEngine', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SABIBufferSize', 'eLEXTYPE_PRIVATE4',
    'DISPID_SOTCEnumerateTokens', 'SpeechInterference', 'SLOStatic',
    'SFTSREngine', 'SSTTWildcard', 'SINone', 'DISPID_SRCERecognition',
    'SAFTCCITT_ALaw_8kHzMono', 'SGSDisabled', 'SPAR_Unknown',
    'DISPID_SGRAddResource', 'DISPID_SVSInputWordLength',
    '__MIDL_IWinTypes_0009', 'DISPID_SVSInputSentenceLength',
    'DISPID_SGRSTsCount', 'DISPID_SLWLangId', 'SINoise',
    'DISPID_SPELexicalForm', 'SPBINARYGRAMMAR',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SPPsItem',
    'DISPID_SpeechRecognizerStatus', 'DISPID_SRCESoundStart',
    'SPWT_DISPLAY', 'DISPID_SRRSaveToMemory',
    'DISPID_SRSCurrentStreamPosition', 'tagSPPROPERTYINFO',
    'DISPID_SRSetPropertyString', 'DISPID_SRCEAudioLevel',
    'DISPID_SRSAudioStatus', 'DISPID_SPPName', 'SpeechRuleAttributes',
    'eLEXTYPE_PRIVATE10', 'SPSTREAMFORMATTYPE', 'SECFIgnoreWidth',
    'SpeechRecoContextState', 'ISpeechGrammarRuleStateTransitions',
    'DISPID_SRGCmdSetRuleState', 'SpInProcRecoContext',
    'DISPID_SpeechObjectTokenCategory', 'IEnumSpObjectTokens',
    'SREAllEvents', 'DISPID_SRGCmdSetRuleIdState', 'SP_VISEME_7',
    'DISPID_SLGetWords', 'SPXMLRESULTOPTIONS', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SOTCId', 'DISPID_SpeechPhraseAlternate',
    'DISPID_SOTDataKey', 'SAFTCCITT_uLaw_11kHzStereo',
    'SpCustomStream', 'SPINTERFERENCE_LATENCY_TRUNCATE_END',
    'DISPID_SRGetPropertyString', 'SVSFParseMask',
    'SPEI_START_SR_STREAM', 'DISPID_SRCEPropertyStringChange',
    'DISPID_SRGState', 'SpeechAudioState', 'SDTProperty',
    'DISPID_SLPs_NewEnum', 'SpeechLoadOption', 'SDKLDefaultLocation',
    'ISpeechRecoResultTimes', 'SpeechCategoryRecognizers',
    'SPEI_PHONEME', 'SPSMF_SAPI_PROPERTIES', 'SPBOOKMARKOPTIONS',
    'SAFT22kHz8BitMono', 'DISPID_SLAddPronunciation',
    'DISPID_SPACommit', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'eLEXTYPE_RESERVED4', 'SPSERIALIZEDRESULT', 'SPPHRASEPROPERTY',
    'DISPID_SpeechAudioBufferInfo', 'eLEXTYPE_PRIVATE1',
    '_RemotableHandle', 'SpeechAllElements',
    'DISPID_SRGDictationUnload', 'DISPID_SRGSetTextSelection',
    'SVP_6', 'SREPrivate', 'SVSFUnusedFlags', 'DISPID_SGRId',
    'SRSEDone', 'DISPID_SGRsFindRule', 'SVP_19',
    'DISPID_SDKGetlongValue', 'DISPID_SRRAudioFormat', 'ISpEventSink',
    'DISPID_SRCEBookmark', 'DISPID_SPCLangId',
    'DISPID_SWFEBitsPerSample', 'SAFT32kHz16BitStereo',
    'DISPID_SVWaitUntilDone', 'SPINTERFERENCE_NOISE',
    'SRADefaultToActive', '_ISpeechRecoContextEvents',
    'DISPID_SVGetProfiles', 'SpeechTokenValueCLSID',
    'DISPID_SVAlertBoundary', 'DISPID_SRCreateRecoContext',
    'SREInterference', 'SP_VISEME_17', 'SPGS_ENABLED', 'SRAONone',
    'DISPID_SOTCreateInstance', 'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SRRRecoContext', 'DISPID_SAVolume',
    'DISPID_SLWPronunciations', 'SPWORDLIST', 'DISPID_SVSVisemeId',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SWFEExtraData',
    'SAFTDefault', 'SPINTERFERENCE_TOOLOUD',
    'ISpeechRecoResultDispatch', 'DISPID_SASNonBlockingIO',
    'DISPID_SRIsShared', 'DISPID_SRRAlternates',
    'DISPID_SPEDisplayText', 'SGSExclusive', 'DISPID_SpeechAudio',
    'DISPID_SPEAudioSizeTime', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SpeechVoice', 'eLEXTYPE_PRIVATE15',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SPRuleParent',
    'DISPID_SRCBookmark', 'SPLO_DYNAMIC', 'DISPIDSPRG',
    'SPEI_UNDEFINED', 'DISPID_SpeechPhraseProperty',
    'ISpPhoneticAlphabetConverter', 'SpeechCategoryAudioOut',
    'DISPID_SVEventInterests', 'DISPID_SpeechRecoResult2',
    'DISPID_SGRAttributes', 'SPFILEMODE', 'SLTUser',
    'ISpResourceManager', 'ISpNotifySink', 'SPADAPTATIONRELEVANCE',
    'SVEStartInputStream', 'ISpeechVoice', 'DISPID_SRGReset',
    'SPVISEMES', 'DISPID_SVSLastBookmark', 'SPFM_OPEN_READONLY',
    'SPEI_RESERVED1', 'DISPID_SPPNumberOfElements',
    'DISPID_SVDisplayUI', 'ISpGrammarBuilder', '_ISpeechVoiceEvents',
    'SRSActive', 'SPEI_MIN_TTS', 'ISpeechBaseStream',
    'SGDSActiveUserDelimited', 'SAFT24kHz16BitStereo',
    'DISPID_SPIEngineId', 'SRTEmulated', 'SAFT44kHz8BitStereo',
    'SVPAlert', 'SpeechVoiceEvents', 'DISPID_SPPConfidence',
    'SPINTERFERENCE', 'SITooQuiet', 'DISPID_SVGetAudioOutputs',
    'SPDKL_CurrentUser', 'SPDATAKEYLOCATION', 'SPSLMA', 'SPWORDTYPE',
    'DISPID_SpeechCustomStream', 'DISPID_SpeechGrammarRules',
    'SSFMCreateForWrite', 'SPEVENT', 'DISPID_SpeechPhraseReplacement',
    'SVP_16', 'DISPID_SLPPhoneIds', 'eLEXTYPE_RESERVED6',
    'DISPID_SGRSTs_NewEnum', 'DISPID_SVEBookmark',
    'SAFT48kHz16BitStereo', 'DISPID_SRCEHypothesis', 'SPCS_ENABLED',
    'SPRECOGNIZERSTATUS', 'SPCT_COMMAND', 'SPBO_AHEAD',
    'DISPID_SOTDisplayUI', 'SAFT12kHz16BitStereo',
    'ISpeechObjectTokenCategory',
    'SpeechGrammarRuleStateTransitionType',
    'DISPID_SPERetainedStreamOffset', 'SAFTGSM610_44kHzMono',
    'SP_VISEME_10', 'STSF_LocalAppData', 'SPFM_OPEN_READWRITE',
    'SPGS_DISABLED', 'SPDKL_DefaultLocation', 'DISPID_SMSGetData',
    'SPEI_MAX_SR', 'SpeechPropertyResponseSpeed', 'SPCATEGORYTYPE',
    'SGDSActiveWithAutoPause', 'SpeechGrammarState',
    'DISPID_SVSLastResult', 'SAFTCCITT_uLaw_22kHzMono',
    'eLEXTYPE_USER', 'DISPID_SRProfile',
    'DISPID_SLRemovePronunciation', 'DISPID_SLPLangId', 'SASRun',
    'DISPID_SpeechObjectTokens', 'SpeechWordType',
    'SPINTERFERENCE_NONE', 'SpeechDiscardType', 'SPRULESTATE',
    'ISpeechPhraseProperty', 'SWPUnknownWordPronounceable',
    'SPWORDPRONUNCIATION', 'ISequentialStream',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPIAudioSizeTime',
    'SPVPRI_ALERT', 'SRAExport', 'SPEI_RESERVED6', 'SRSEIsSpeaking',
    'ISpRecoContext', 'DISPID_SRCEAdaptation',
    'SpeechCategoryAudioIn', 'SREStateChange', 'ISpNotifySource',
    'eLEXTYPE_PRIVATE20', 'SAFT22kHz16BitMono', 'ISpeechAudio',
    'SpeechCategoryAppLexicons', 'SAFT16kHz8BitStereo', 'SP_VISEME_0',
    'DISPID_SPRFirstElement', 'SPEI_RECO_OTHER_CONTEXT',
    'SPEI_SENTENCE_BOUNDARY', 'DISPID_SGRSTPropertyId',
    'SpeechTokenKeyUI', 'DISPID_SpeechPhoneConverter',
    'DISPID_SPRsCount', 'eLEXTYPE_PRIVATE3', 'eLEXTYPE_PRIVATE11',
    'SAFTCCITT_ALaw_22kHzStereo', 'SWTDeleted', 'DISPID_SMSAMMHandle',
    'SAFT22kHz16BitStereo', 'SFTInput', 'SPPARTOFSPEECH',
    'SVSFNLPSpeakPunc', 'DISPID_SRSCurrentStreamNumber', 'SVP_12',
    'DISPID_SVSInputSentencePosition', 'SAFTADPCM_8kHzMono',
    'DISPID_SpeechDataKey', 'SpNotifyTranslator',
    'SpeechPropertyLowConfidenceThreshold', 'SpStreamFormatConverter',
    'SRTExtendableParse', 'SECLowConfidence', 'ISpRecoGrammar',
    'SP_VISEME_1', 'SPSHORTCUTTYPE', 'ISpStreamFormat', 'SSFMCreate',
    'SBONone', 'SPSHT_NotOverriden', 'SSFMOpenReadWrite',
    'DISPID_SPRsItem', 'DISPID_SPIElements',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS', 'STSF_FlagCreate',
    'SECHighConfidence', 'DISPID_SVResume', 'ISpeechPhoneConverter',
    'DISPID_SPEsCount', '_SPAUDIOSTATE', 'SDA_Consume_Leading_Spaces',
    'SpeechRecoProfileProperties', 'SPGRAMMARSTATE',
    'ISpPhoneConverter', 'ISpeechRecoResult', 'SVF_None',
    'DISPID_SRGCmdLoadFromMemory', 'SVSFNLPMask',
    'SpPhraseInfoBuilder', 'SAFTADPCM_11kHzStereo', 'SPFM_NUM_MODES',
    'SLODynamic', 'SREBookmark', 'SRSInactive', 'SPAO_RETAIN_AUDIO',
    'SPXRO_SML', 'DISPID_SOTId', 'UINT_PTR',
    'SpeechStreamSeekPositionType',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SVEEnginePrivate', 'DISPID_SOTRemove', 'SpMMAudioIn',
    'DISPID_SPPsCount', 'SpUnCompressedLexicon', 'DISPID_SPRuleName',
    'SpeechAudioVolume', 'DISPID_SpeechPhraseRules',
    'DISPID_SpeechRecoResult', 'SGLexical', 'SAFT12kHz16BitMono',
    'SpeechTokenIdUserLexicon', 'DISPID_SCSBaseStream',
    'SpeechVoiceSpeakFlags', 'DISPID_SVIsUISupported',
    'DISPID_SPRuleId', 'SVEBookmark', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpeechRecoContext', 'WAVEFORMATEX', 'SPVPRI_NORMAL',
    'DISPID_SpeechMemoryStream', 'SpeechGrammarTagWildcard',
    'DISPID_SRCCreateResultFromMemory', 'SPPS_LMA', 'SPPS_Noun',
    'DISPID_SAFGetWaveFormatEx', 'DISPID_SRSSupportedLanguages',
    'SRCS_Disabled', 'SpeechFormatType', 'SPVOICESTATUS',
    'DISPID_SpeechPhraseElements', 'SPAS_CLOSED', 'DISPID_SRState',
    'eLEXTYPE_RESERVED7', 'tagSPTEXTSELECTIONINFO',
    'SAFTNoAssignedFormat', 'SPRST_NUM_STATES', 'SpeechTokenKeyFiles',
    'SSTTDictation', 'SpObjectTokenCategory', 'SRTSMLTimeout',
    'SREFalseRecognition', 'DISPID_SLPsCount',
    'SWPKnownWordPronounceable', 'ISpeechGrammarRuleState',
    'SVSFParseAutodetect', 'SDTRule', 'DISPID_SWFEAvgBytesPerSec',
    'DISPID_SBSRead', 'DISPID_SASState', 'DISPID_SPRText',
    'ISpStream', 'SVEWordBoundary', 'DISPID_SDKSetStringValue',
    'SPPS_RESERVED3', 'DISPID_SpeechLexiconWords',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPRS_ACTIVE_USER_DELIMITED',
    'SPRECOCONTEXTSTATUS', 'ISpeechRecoGrammar',
    'ISpStreamFormatConverter', 'SpeechMicTraining',
    'DISPID_SOTCSetId', 'DISPID_SAFSetWaveFormatEx',
    'DISPID_SWFEBlockAlign', 'ISpeechPhraseInfo',
    'DISPID_SpeechAudioStatus', 'SpShortcut', 'SAFTGSM610_8kHzMono',
    'eLEXTYPE_PRIVATE6', 'DISPID_SVEStreamStart', 'SPAUDIOBUFFERINFO',
    'SPCT_SLEEP', 'SpSharedRecoContext',
    'DISPID_SRCERecognitionForOtherContext', 'SpObjectToken',
    'SpLexicon', 'ISpLexicon', 'DISPID_SRCEPhraseStart',
    'SVSFDefault', 'SRATopLevel', 'DISPID_SVSkip', 'DISPID_SGRSTRule',
    'SpeechSpecialTransitionType', 'ISpSerializeState',
    'DISPID_SOTsItem', 'SVEPrivate', 'DISPID_SVGetVoices',
    'SPEI_RESERVED3', 'eLEXTYPE_APP', 'SPPS_RESERVED1', 'SVP_0',
    'DISPID_SBSFormat', '__MIDL___MIDL_itf_sapi_0000_0020_0002',
    'SPSNoun', 'LONG_PTR', 'DISPID_SPIGetDisplayAttributes',
    'SPWORDPRONUNCIATIONLIST', 'SPDKL_CurrentConfig',
    'SpeechAudioFormatGUIDWave', 'SPCT_DICTATION', 'SpeechVisemeType',
    'SVP_4', 'SVP_21', 'eLEXTYPE_PRIVATE14', 'SRERequestUI',
    'SAFTExtendedAudioFormat', 'DISPID_SABIMinNotification',
    'SpMMAudioOut', 'DISPID_SPRuleChildren', 'SAFT16kHz16BitMono',
    'DISPID_SGRsCount', 'SPPS_Function', 'DISPID_SFSClose',
    'DISPID_SGRSTText', 'SPPHRASEREPLACEMENT', 'DISPID_SMSALineId',
    'ISpeechMMSysAudio', 'SPRULE', 'DISPID_SpeechVoiceStatus',
    'DISPID_SpeechRecoResultTimes', 'SPSModifier', 'SPEI_SOUND_START',
    'SpeechPropertyAdaptationOn', 'DISPID_SPIEnginePrivateData',
    'SpeechGrammarWordType',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet', 'SWTAdded',
    'SPAR_Low', 'SPEI_SOUND_END', 'DISPIDSPTSI_ActiveLength',
    'ISpObjectWithToken', 'SPSERIALIZEDPHRASE', 'SPRS_INACTIVE',
    'DISPID_SBSWrite', 'DISPID_SLWType', 'DISPID_SLPPartOfSpeech',
    'SpeechRetainedAudioOptions', 'DISPID_SRCEStartStream',
    'ISpeechGrammarRuleStateTransition', 'DISPID_SOTIsUISupported',
    'SAFT48kHz16BitMono', 'ISpEventSource', 'DISPID_SPIGrammarId',
    'DISPID_SPPParent', 'ISpeechAudioFormat', 'SAFT24kHz16BitMono',
    'DISPID_SPIRetainedSizeBytes', 'DISPID_SABufferNotifySize',
    'SpMMAudioEnum', 'SPEVENTENUM', 'DISPIDSPTSI_SelectionOffset',
    'ISpPhraseAlt', 'DISPID_SPEEngineConfidence', 'SVSFParseSapi',
    'DISPID_SRCCmdMaxAlternates', 'Speech_StreamPos_RealTime',
    'DISPID_SREmulateRecognition', 'DISPID_SVEAudioLevel',
    'SPSInterjection', 'DISPID_SLWsCount', 'SAFTGSM610_22kHzMono',
    'DISPID_SRCRetainedAudio', 'SGDisplay', 'SP_VISEME_9',
    'DISPID_SVSPhonemeId', 'DISPID_SPRules_NewEnum', 'SPEI_RESERVED5',
    'SPEI_WORD_BOUNDARY', 'SPGS_EXCLUSIVE', 'DISPID_SRRTimes',
    'DISPID_SPAStartElementInResult', 'DISPID_SPIReplacements',
    'DISPID_SGRSTWeight', 'DISPID_SDKEnumKeys', 'SPEI_VOICE_CHANGE',
    'SAFT48kHz8BitStereo', 'SGDSActive', 'ISpeechMemoryStream',
    'SSTTTextBuffer', 'DISPID_SRGId', 'tagSTATSTG',
    'SPFM_CREATE_ALWAYS', 'DISPID_SAEventHandle',
    'SAFT12kHz8BitStereo', 'ISpeechLexicon', 'SPEI_TTS_BOOKMARK',
    'DISPID_SRGRules', 'DISPIDSPTSI_ActiveOffset', 'ISpXMLRecoResult',
    'eLEXTYPE_PRIVATE12', 'SpeechPropertyComplexResponseSpeed',
    'SDTReplacement', 'SVP_20', 'DISPID_SpeechGrammarRule',
    'SP_VISEME_6', 'SVEPhoneme', 'DISPID_SpeechLexicon', 'SPAS_PAUSE',
    'SpeechTokenShellFolder', 'DISPID_SVSInputWordPosition',
    'SP_VISEME_14', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SDKOpenKey', 'ISpPhoneticAlphabetSelection',
    'eLEXTYPE_PRIVATE7', 'ISpeechPhraseReplacements',
    'DISPID_SPEActualConfidence', 'SRTReSent', 'DISPID_SBSSeek',
    'DISPID_SPCPhoneToId', 'ISpeechFileStream',
    'DISPID_SPRuleFirstElement', 'SPRECOSTATE', 'SPAUDIOSTATE',
    'SVP_13', 'SREPropertyStringChange', 'eLEXTYPE_RESERVED10',
    'SAFTCCITT_ALaw_8kHzStereo', 'DISPID_SVAudioOutputStream',
    'DISPID_SVStatus', 'SPLOADOPTIONS', 'DISPID_SRCState',
    'SAFTADPCM_44kHzMono', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SPISaveToMemory', 'SpeechEngineConfidence',
    'SPEI_RESERVED2', 'SECFEmulateResult', 'ISpDataKey',
    'eLEXTYPE_USER_SHORTCUT', 'ISpeechRecognizerStatus',
    'DISPID_SDKCreateKey', 'SPPROPERTYINFO', 'DISPID_SGRInitialState',
    'DISPID_SGRSTNextState', 'SpeechAudioProperties',
    'DISPIDSPTSI_SelectionLength', 'SRAInterpreter',
    'DISPID_SVSpeakCompleteEvent', 'SPWAVEFORMATTYPE',
    'DISPID_SpeechPhraseInfo', 'SpeechAudioFormatType',
    'ISpeechResourceLoader', 'SDTLexicalForm', 'SAFT44kHz16BitStereo',
    'DISPID_SRRSetTextFeedback', 'SpeechRecognitionType',
    'SAFTCCITT_uLaw_11kHzMono', 'SGRSTTEpsilon', 'ISpObjectToken',
    'SPWF_INPUT', 'SVSFVoiceMask', 'SPEI_INTERFERENCE',
    'DISPID_SRCVoicePurgeEvent', 'SAFTADPCM_22kHzMono',
    'SpeechDataKeyLocation', 'SpMemoryStream', 'SAFT8kHz16BitMono',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_11',
    'DISPID_SRCEEndStream'
]

_check_version('1.2.0', 1688202596.252056)
